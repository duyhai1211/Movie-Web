                ...
                <div className="flex flex-col space-y-5 items-baseline w-[50%]">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="text-white">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus adipisci laboriosam
                            odit, quis quam quibusdam officia natus tempora veniam, voluptate iste inventore quae
                            labore. Temporibus nisi quod minus numquam rem!
                        </p>
